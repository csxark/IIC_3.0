      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/" className="flex items-center space-x-3 transition-transform duration-300 hover:scale-102">
              <img id="logo" role="button" alt="MUJ-Logo.png"
                  src="/muj-logo.png" width="130"
              />
            </Link>

            
            <div className="w-px h-6 bg-gradient-to-b from-pink-400 to-cyan-400 opacity-40"></div>

            
            <Link to="/" className="flex items-center space-x-3 transition-transform duration-300 hover:scale-102">
              <img id="logo" role="button" alt="IIC-Logo.png"
                   src="/iic-logo.png" width="90"
              />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              <Zap size={14} className="inline mr-1.5 fill-white" />
              Submit
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 px-3 bg-slate-950/90 border border-white/10 backdrop-blur-2xl rounded-2xl shadow-2xl animate-fade-in">
            ...
            <button
              ...
              className="block w-full mt-3 modern-button py-3 rounded-xl font-bold text-center transition-all duration-300 active:scale-98 shadow-lg"
            >
